...
const ManageBikes = () => {
  ...
  return (
    <div className='p-6 font-[oswald] '>
      <div className='flex items-center mb-4 gap-2 text-blue-600 text-2xl'>
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3'>
        <div className='relative w-full md:w-auto'>
          <FaMotorcycle className='absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-500' />
          <input
            type='text'
            name='brand'
            value={filters.brand}
        ...
        <div className='relative w-full md:w-auto'>
          <BsCheckCircle className='absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-500' />
          <select
            name='availability'
      ...
      <Table className='mt-6 border border-blue-600'>
        <TableHeader>
          <TableRow className='border border-blue-600'>
            ...
            <TableHead className='text-blue-600'>Price Per Hour</TableHead>
            <TableHead className='text-blue-600'>CC</TableHead>
            <TableHead className='text-blue-600'>Year</TableHead>
            <TableHead className='text-blue-600'>Brand</TableHead>
            <TableHead className='text-blue-600'>Model</TableHead>
            <TableHead className='text-blue-600'>Availability</TableHead>
        ...
        <TableBody>
          {!filteredData || filteredData.length === 0 ? (
            <TableRow>
              <TableCell
                colSpan={7}
                className='text-center text-blue-600 text-2xl font-semibold'
              >
                No Bikes Found
              </TableCell>
            </TableRow>
