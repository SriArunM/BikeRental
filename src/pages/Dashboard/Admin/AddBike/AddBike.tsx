        ...
        <CardContent className='p-6'>
          ...
          >
            <div className='grid gap-2 my-3'>
              <Label className='text-blue-600 font-bold' htmlFor='name'>
                Name
              </Label>
              <Input
                id='name'
            ...
            <div className='grid gap-2'>
              <Label className='text-blue-600 font-bold' htmlFor='brand'>
                Brand
              </Label>
              <Input
                id='brand'
            ...
            <div className='grid gap-2'>
              <Label className='text-blue-600 font-bold' htmlFor='model'>
                Model
              </Label>
              <Input
                id='model'
            ...
            <div className='grid gap-2'>
              <Label className='text-blue-600 font-bold' htmlFor='year'>
                Year
              </Label>
              <Input
                id='year'
            ...
            <div className='grid gap-2'>
              <Label className='text-blue-600 font-bold' htmlFor='cc'>
                CC
              </Label>
              <Input
                id='cc'
            ...
            <div className='grid gap-2'>
              <Label className='text-blue-600 font-bold' htmlFor='image'>
                Image url{' '}
              </Label>
              <Input
                id='image'
