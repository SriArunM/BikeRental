      ...
      <Table className='mt-6 border border-blue-600'>
        <TableHeader>
          <TableRow className='border border-blue-600'>
            <TableHead className='text-blue-600'>Bike Id</TableHead>
            <TableHead className='text-blue-600'>Start Time</TableHead>
            <TableHead className='text-blue-600'>Return Time</TableHead>
            <TableHead className='text-blue-600'>Returned</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {allRentals.length > 0 ? (
            ...
            <TableRow>
              <TableCell
                colSpan={4}
                className='text-center font-bold text-xl text-blue-600'
              >
