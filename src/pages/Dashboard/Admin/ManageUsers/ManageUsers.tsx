      ...
      <Table className='mt-6 border border-blue-600'>
        <TableHeader>
          <TableRow className='border border-blue-600'>
            ...
            <TableHead className='text-blue-600'>Change Role</TableHead>
        ...
        <TableBody>
          {users?.length === 0 ? (
            <TableRow>
              <TableCell colSpan={7} className='text-center text-blue-600'>
                No User Found
              </TableCell>
            </TableRow>
          ) : (
                ...
                <TableCell>
                  {isUpdatingRole ? (
                    ...
                    <select
                      ...
                      className='select-filter md:w-64 pl-10 pr-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
                    >
