      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='mb-7'>
          <div className='flex justify-center'>
            <IoMdContacts className='text-5xl font-extrabold text-blue-600' />
          </div>
          ...
          <div className='block group md:col-span-2 lg:col-span-1'>
            <div className='relative mb-6'>
              <img
                ...
                alt='Antonio image'
                className='w-40 h-40 rounded-full mx-auto transition-all duration-500 object-cover border border-solid border-transparent group-hover:border-blue-600'
              />
            </div>
            <h4 className='text-xl font-semibold text-gray-900 mb-2 capitalize text-center transition-all duration-500 group-hover:text-blue-400'>
              Nabiur Siddique
            </h4>
