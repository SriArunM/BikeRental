  ...
  return (
    <div className='relative w-full lg:h-[600px] h-[600px] bg-black cursor-pointer lg:p-5 px-3 flex flex-col'>
      <div className='grid grid-cols-1 items-center px-5 pt-1'>
        <h1 className='text-blue-600 lg:text-xl text-sm font-extrabold truncate'>
          {bikeName}
        </h1>
      </div>
      ...
      <div className='bg-black text-white mt-2 flex-grow'>
        <div className='grid grid-cols-2 gap-4'>
          <div className='grid grid-cols-4 items-center'>
            <FaMotorcycle className='text-blue-600 text-xl mr-2' />
          ...
          <div className='flex items-center'>
            <FaCog className='text-blue-600 text-xl mr-3' />
            <div>
          ...
          <div className='flex items-center'>
            <FaTachometerAlt className='text-blue-600 text-xl mr-3' />
            <div>
      ...
      <div className='bg-black text-white p-4 grid grid-cols-2 items-center'>
        ...
        <Link
          to={`/bike-details/${id}`}
          className='text-on-dark bg-blue-600 text-center text-sm font-bold py-2 px-4 smoothingAnimation hover:bg-blue-700 transition-colors duration-300'
        >
          View Details
        </Link>
      </div>
