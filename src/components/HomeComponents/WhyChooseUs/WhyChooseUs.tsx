...
const features = [
  {
    ...
    icon: <FaMotorcycle className='w-12 h-12 text-red-600' />,
  },
  {
  ...
  },
  {
    ...
    icon: <FaRegCalendarAlt className='w-12 h-12 text-orange-600' />,
  },
  {
    ...
    icon: <FaTachometerAlt className='w-12 h-12 text-green-600' />,
  },
];
    ...
    <div className='font-[oswald] max-w-6xl lg:mx-auto mx-5 py-10'>
      <div className='mb-5'>
        ...
        <h1 className='lg:text-5xl text-3xl font-semibold uppercase lg:mt-5 text-center'>
          Why Choose Us
          <span className='text-blue-400 lg:text-6xl text-3xl'>?</span>
        </h1>
      </div>
